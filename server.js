...
// app.get('/views/mogo_card/search',(req, res)=>{
// 	const { search }= req.query;
// 	imgModel.find({ where: {Occupation:{ [Op.like]: '%' + search + '%'}}}, function(err,imgModel){
// 		res.render('search_view',{UserList2: imgModel})
// 	})
// 	// .then( gigs => res.render('search_view' , { UserList2: imgModel })).catch( err => console.log( err));

// 	// const searchField= req.query.Occupation;
// 	// imgModel.find({Occupation: {$regex: searchField, $options: '$i'}})
// 	// .then(data=>{
// 	// 	res.send(data);
// 	// })
// });
